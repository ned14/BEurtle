...
namespace TestContainer
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var result = plugin.GetCommitMessage((IntPtr)null, "", @"G:\BEurtle\TestContainer\bugs.bugseverywhere.org.xml", null, "An original commit message");
            //var result = plugin.GetCommitMessage((IntPtr)null, "", @"G:\Oxyderkeia", null, "An original commit message");
            //var result = plugin.GetCommitMessage((IntPtr)null, "", @"G:\BEurtle", null, "An original commit message");
